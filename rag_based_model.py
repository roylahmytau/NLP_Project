...
def setup_cache_directories():
    # Use the existing team cache directory where Qwen3-8B is already downloaded
    cache_dir = "/root/.cache/huggingface"
    
    # Set environment variables to use existing cache
...
class RAGModel:
    ...
    def setup_from_text(self, text: str):
        ...
        # Use smaller model that fits in GPU memory
                # Use Qwen model - fix the model name and task type
        print("📥 Loading Qwen3-8B model from team's existing cache...")
        print("💡 Using trust_remote_code to handle unknown model type...")
        ...
        prompt_model = PromptModel(
            ...
            model_kwargs={
                ...
                "trust_remote_code": True  # This should allow unknown model types
            }
        )
